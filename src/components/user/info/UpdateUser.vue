            ...
            <v-card>
                ...
                <v-card-text style="max-height: 320px;">
                    <v-form>
                        <v-text-field 
                            label="First Name"
                            v-model.trim="update.first_name"
                        ></v-text-field>
                        <v-text-field 
                            label="Last Name"
                            v-model.trim="update.last_name"
                        ></v-text-field>
                        <v-text-field 
                            label="Email"
                            v-model.trim="update.email"
                        ></v-text-field>
                        <v-text-field 
                            label="Password"
                            type="password"
                            v-model.trim="update.password"
                        ></v-text-field>
...
export default {
    ...
    methods: {
        submit () {
            if (!this.update.first_name || !this.update.last_name || !this.update.email || !this.update.password) {
            ...
            let url = this.$baseUrl + '/Users/update_admin'
        ...
        reset () {
            this.error = null
            this.update.id = ''
            this.update.first_name = ''
            this.update.last_name = ''
            this.update.email = ''
